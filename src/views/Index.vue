...
.ban{
  background: url(https://img.freepik.com/free-vector/smooth-white-wave-background_52683-55288.jpg?t=st=1653504682~exp=1653505282~hmac=6b2082001ebf577a66d33422bc039cb4370db5ee4b4a28d8b2e1c8263d19c3c3&w=740);  background-size: 100% 100%;
  background-position-x:center;
  height:500px; 
  width:100%;
}

  ...
  >
    ...
    <b-collapse is-nav id="app-layout-navbar2">
      ...
      <b-navbar-nav
        ...
        class="align-items-lg-center ml-lg-auto"
      >
        <b-nav-item to="/news">
          <span class="nav-link-inner--text" style="color: #cecece">
            اخبار
          </span>
        </b-nav-item>
      ...
      <b-navbar-nav
        style="margin-right"
        class="align-items-lg-center mr-lg-auto"
      >
        <b-nav-item v-if="this.$store.state.isAuthenticated" to="/dashboard">
          <span
            class="nav-link-inner--text btn btn-warning"
            style="
              padding: 7px 15px;
      ...
      <b-navbar-nav @click="seen()" class="align-items-lg-center ml-auto">
        <b-nav-item>
          <template>
            <i
              v-if="!darkness"
              class="ion ion-md-moon navbar-icon align-middle"
              style="margin-left: 12px; margin-right: 12px"
              @click="darkswitch"
            ></i>
            <i
              v-else
              class="ion ion-md-sunny navbar-icon align-middle"
              style="margin-left: 12px; margin-right: 12px"
              @click="darkswitch"
            ></i>
          </template>
        ...
        >
          ...
          <b-list-group style="max-height: 480px; overflow-y: auto" flush>
            <b-list-group-item
              v-for="(item, idx) in notification"
              v-bind:key="idx + 'n'"
              href="javascript:void(0)"
              class="media d-flex align-items-center"
            >
              <div
                class="ui-icon ui-icon-sm ion ion-md-notifications-outline bg-secondary border-0 text-white"
              ></div>
        ...
        >
          <template slot="button-content" @click="read()">
            <i
              @click="read()"
              class="ion ion-ios-mail navbar-icon align-middle"
            ></i>
            <span
              v-if="tunseen"
              class="badge badge-primary badge-dot indicator"
          ...
          <b-list-group flush>
            ...
            <a
              v-if="!tickets.length"
              href="javascript:void(0)"
              class="text-center text-light font-weight-bold p-3"
              >No Tickets Yet</a
            >
          </b-list-group>
          <a
            ...
            class="bg-primary text-white d-block text-center small p-2 my-1"
            >New Ticket</a
          >
        </b-nav-item-dropdown>
          ...
          <template slot="button-content">
            ...
            >
              <i
                ...
                class="ion ion-ios-person text-light"
              ></i>
            </span>
          </template>

          <b-dd-item href="/user"
            ><i class="ion ion-ios-person text-lightest"></i> &nbsp; اطلاعات
            کاربری</b-dd-item
          >
          <b-dd-item href="/user-level"
            ><i class="ion ion-ios-mail text-lightest"></i> &nbsp; تایید
            هویت</b-dd-item
          >
          <b-dd-item href="/user-security"
            ><i class="ion ion-md-settings text-lightest"></i> &nbsp;
            امنیت</b-dd-item
          >
          <b-dd-divider />
          <b-dd-item href="/logout"
    ...
    >
      ...
      <b-navbar-nav class="align-items-lg-center ml-auto">
        ...
        <b-nav-item>
          <template>
            <button @click="login()" class="btn btn-primary">ثبت نام</button>
          </template>
        </b-nav-item>
      </b-navbar-nav>
    </b-collapse>

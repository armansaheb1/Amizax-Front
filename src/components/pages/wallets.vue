      ...
      <input class="form-control" type="search" placeholder="search..." style="textalign:left;direction:ltr;font-family:'arial'" @input="search2()" v-model="searchtext"><br>
        ...
        <tbody>
          <tr v-for="(section) in wallets" v-bind:key="section.name">
                  ...
                  <td v-if="section.brand === 'USDT'" style="padding:0;font-family:'arial';font-size:14px"><router-link  :to="`/cpwallets/${section.name}/withdraw`" class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'">برداشت</router-link><router-link :to="`/cpwallets/${section.name}/history`"  class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'"> تاریخچه </router-link><router-link :to="`/buy/${section.brand}`"  class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'"> خرید </router-link><router-link :to="`/sell/${section.brand}`"  class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'"> فروش </router-link><router-link   :to="`/cpwallets/${section.name}/deposit`" class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'">واریز</router-link></td>
          </tr>
          <tr v-for="(section) in wallets" v-bind:key="section.name">
                  ...
                  <td v-if="section.brand !== 'USDT' && (parseFloat(parseFloat(section.balance).toFixed(6)) !== 0)" style="padding:0;font-family:'arial';font-size:14px"><router-link  :to="`/cpwallets/${section.name}/withdraw`" class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'">برداشت</router-link><router-link :to="`/cpwallets/${section.name}/history`"  class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'"> تاریخچه </router-link><router-link :to="`/buy/${section.brand}`"  class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'"> خرید </router-link><router-link :to="`/sell/${section.brand}`"  class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'"> فروش </router-link><router-link   :to="`/cpwallets/${section.name}/deposit`" class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'">واریز</router-link></td>
          </tr>
          <tr v-for="(section) in wallets" v-bind:key="section.name">
          ...
          <tr v-for="(section) in wallets" v-bind:key="section.id">
                  ...
                  <td v-if="section.brand !== 'USDT' && !(section.brand == 'BTC' |section.brand == 'ETH' |section.brand == 'TRX') && (parseFloat(parseFloat(section.balance).toFixed(6)) === 0)" style="padding:20px;font-family:'arial';font-size:14px"> <router-link :to="`#`"><a v-if="(parseFloat(parseFloat(section.balance).toFixed(6)) === 0)">0</a> <a v-if="(parseFloat(parseFloat(section.balance).toFixed(6)) !== 0)">{{parseFloat(section.balance).toFixed(6)}}</a></router-link></td>
                  <td v-if="section.brand !== 'USDT' && !(section.brand == 'BTC' |section.brand == 'ETH' |section.brand == 'TRX') && (parseFloat(parseFloat(section.balance).toFixed(6)) === 0)" style="font-family:'arial'"><br><a v-if="prices[section.brand + 'USDT']">{{prices[section.brand + 'USDT'].buy}}</a></td>
                  <td v-if="section.brand !== 'USDT' && !(section.brand == 'BTC' |section.brand == 'ETH' |section.brand == 'TRX') && (parseFloat(parseFloat(section.balance).toFixed(6)) === 0)" style="padding:0;font-family:'arial';font-size:14px"><router-link  :to="`/cpwallets/${section.name}/withdraw`" class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'">برداشت</router-link><router-link :to="`/wallets/${section.name}/history`"  class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'"> تاریخچه </router-link><router-link :to="`/buy/${section.brand}`"  class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'"> خرید </router-link><router-link :to="`/sell/${section.brand}`"  class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'"> فروش </router-link><router-link   :to="`/cpwallets/${section.name}/deposit`" class="btnfont btn btn-dark walbtn" style="font:16px 'Yekan'">واریز</router-link></td>

      ...
      <input class="form-control" type="search" placeholder="search..." style="textalign:left;direction:ltr;font-family:'arial'" @input="search2()" v-model="searchtext"><br>
        ...
        <tbody>
          <tr v-for="(section) in wallets" v-bind:key="section.name">
                  ...
                  <td v-if="section.brand === 'USDT'" style="padding:20px;font-family:'arial';font-size:14px"> <router-link :to="`#`"><a v-if="(parseFloat(section.balance) === 0)">0</a> {{section.balance}}</router-link></td>
          ...
          <tr v-for="(section) in wallets" v-bind:key="section.name">
                  ...
                  <td v-if="section.brand !== 'USDT' && (section.brand == 'BTC' |section.brand == 'ETH' |section.brand == 'TRX' && (parseFloat(section.balance) === 0))" style="font-family:'arial'"><br><a v-if="prices[section.brand + 'USDT']">{{prices[section.brand + 'USDT'].buy}}</a></td>

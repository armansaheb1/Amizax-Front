    ...
    <h4 class="d-flex flex-wrap justify-content-between align-items-center pt-3 mb-4">
      <div class="col-12 col-md-3 p-0 ">
       ...
       <b-card>
        ...
        <h5 style="float:right" v-if="currencies.amount">موجودی : <a @click="balanceset()" class="btn btn-dark" style="font:12px 'UD'; padding:5px 20px">{{parseInt(currencies.amount)}}</a> ریال </h5><br>

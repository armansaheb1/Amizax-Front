    ...
    <b-card>
      ...
      <fieldset  class="demo-vertical-spacing-sm">
        ...
        <input @input="search()" type="text" class="form-control" placeholder="search ..." v-model="searchtxt" style="border-radius: 5px 5px 0 0; border-color:lightgrey!important">
          ...
          <select v-if="wallets" class="form-control" v-model="chain" @change="getfee()" style="font-family:'UD'!important">
        ...
        <h5 style="float:right; color:#888" v-if="price && rialprice">هزینه جا به جایی : <a class="btn btn-dark" style="font:12px 'UD'; padding:5px 20px "> {{ parseInt(fee * price.buy  * rialprice[0].rial * 1.07)}} ریال</a></h5><br><br>
        <h5 style="float:right; color:#888" v-if="price && rialprice">دریافتی : <a v-if="getting > 0" class="btn btn-dark" style="font:12px 'UD'; padding:5px 20px ">{{getting}}</a><a v-else class="btn btn-dark" style="font:12px 'UD'; padding:5px 20px ">0</a></h5><br><br>
